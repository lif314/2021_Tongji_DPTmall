...
public class ExpressionUtil {
    public static boolean isVerb(String word) {
        return "Rollback".equals(word)||"Edit".equals(word)||"Add".equals(word)||"Complaint".equals(word) ||"Get".equals(word) ||"Create".equals(word) || "Display".equals(word) || "Select".equals(word) || "Login".equals(word) || "Enter".equals(word) ||  "Buy".equals(word) ||  "Delete".equals(word);
    }
